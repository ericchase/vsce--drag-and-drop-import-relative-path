...
import { selectors } from './original-repo/src/providers/selector.js';
import { AutoImportOnDropProvider } from './original-repo/src/subscriptions/auto-import-on-drop-provider.js';
